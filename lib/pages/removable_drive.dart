...
class RemovableDrive extends StatefulWidget {
  const RemovableDrive({super.key});

  @override
  State<RemovableDrive> createState() => _RemovableDriveState();
}

class _RemovableDriveState extends State<RemovableDrive> {
  @override
      ...
      builder: (context, diskInfoProvider, child) {
        ...
        return Column(
          ...
          children: diskInfoMap.entries.map((diskType) {
            if (diskType.key.contains('Removable')) {
              return Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Heading(
                          text: '$removableDrive (${diskType.value.length})',
                          size: bigHeadingSize,
                        ),
                      ],
                    ),
            ...
            } else if (diskType.key.contains('Removable') == 0) {
              return const Center(
                child: Text('Empty'),
              );
            } else
